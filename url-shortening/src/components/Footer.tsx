...
const Footer = (props: Props) => {
  return (
    <footer className="bg-[#232127] text-center text-white py-14">
      <div className="grid gap-12 xl:flex xl:justify-between lg:items-center lg:px-40 lg:py-[1rem] lg:text-left lg:max-w-[90rem] lg:m-auto">
        <img
          className="m-auto xl:m-[unset] xl:self-start"
          src={logoWhite}
          alt=""
        />
        <ul className="text-[#9e9aa7] font-medium text-sm space-y-9 m-auto lg:flex lg:space-y-[unset] lg:gap-[5.5rem] xl:translate-x-[5.25rem] xl:tracking-wide">
          <li>
            <ul className="space-y-[0.9375rem] lg:space-y-3.5">
              <li className="font-bold text-white text-base pb-1.5">
                Features
              </li>
